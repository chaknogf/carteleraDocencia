...
[data-bs-theme=dark] {
  ...
  --bs-primary-text-emphasis: #7db3ee;
  ...
  --bs-primary-border-subtle: #174d88;
...
@font-face {
  font-family: 'Altivo';
  src: url('assets/fonts/altivo-normal.otf') format('opentype');
  font-weight: normal;
  font-style: normal;
}
...
@font-face {
  font-family: 'Altivo';
  src: url('assets/fonts/altivo-negrita.otf') format('opentype');
  font-weight: bold;
  font-style: normal;
}
...
body {
  ...
  background: linear-gradient(55deg, rgb(203, 215, 227), skyblue);
...
/* Contenedor principal tipo libreta moderna */
.notebook-container {
  position: relative;
  width: 99dvw;
  background: linear-gradient(55deg, rgb(203, 215, 227), skyblue);
...
.option-glass input[type="radio"]:checked {
  background: #eaedef;
}

.option-glass input[type="radio"]:checked::after {
  content: "✓";
  color: #045cb4;
  position: absolute;
  top: -5px;
